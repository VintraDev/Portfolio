            ...
            <div className="flex gap-4 flex-col md:flex-row">
                <div className="flex-1">
                    ...
                    <p className="text-(--tertiary-color) font-work-sans">
                        Contribuindo e construindo projetos escaláveis, profissionais e de alta performance. Da prototipação inicial ao deploy final.
                    </p>

                    <img className="mt-4 object-cover rounded-md border-2 border-(--primary-color) md:hidden" src="/img/FeedbackAnalytics.png" alt="Feedback Analytics picture" />


                    <div className="flex flex-col mt-4">
                        <Cards items={items} renderContent={(item) => (
                            <div className="flex flex-row items-center gap-3 p-4">
                                <img className="w-12 shrink-0" src={item.image} alt={item.title} />
                                <div>
                ...
                <div className="flex-1 relative overflow-hidden rounded-l-md border-2 border-(--primary-color) border-r-0 -right-6 md:-right-10 lg:-right-20 hidden md:block">
                    <img className="absolute right-0 w-full h-full object-cover object-left" src="/img/FeedbackAnalytics.png" alt="Feedback Analytics picture" />
                </div>
            </div>
        </section>
    )
